const palette = {
  paper: [0.085, 0.036, 258],
  paper2: [0.125, 0.046, 254],
  paper3: [0.175, 0.058, 248],
  ink: [0.95, 0.026, 205],
  ink2: [0.84, 0.042, 215],
  muted: [0.72, 0.046, 224],
  accent: [0.85, 0.165, 195],
  accentInk: [0.11, 0.042, 252],
  focus: [0.91, 0.145, 190],
  buy: [0.85, 0.185, 148],
  buySurface: [0.19, 0.058, 155],
  sell: [0.75, 0.205, 24],
  sellSurface: [0.19, 0.064, 24],
  wait: [0.85, 0.135, 82],
  waitSurface: [0.19, 0.048, 82]
};
