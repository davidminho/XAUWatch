const palette = {
  ...
  paper2: [0.96, 0.007, 250],
  paper3: [0.925, 0.010, 252],
  ink: [0.22, 0.020, 258],
  ink2: [0.34, 0.018, 257],
  muted: [0.46, 0.018, 255],
  accent: [0.53, 0.22, 256],
  accentInk: [0.985, 0.004, 250],
  focus: [0.45, 0.22, 256],
  buy: [0.42, 0.14, 155],
  buySurface: [0.94, 0.030, 155],
  sell: [0.48, 0.18, 25],
  sellSurface: [0.95, 0.028, 25],
  wait: [0.43, 0.12, 84],
  waitSurface: [0.95, 0.028, 84]
};
