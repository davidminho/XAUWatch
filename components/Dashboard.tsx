    ...
    <>
      ...
      <main className="dashboard" id="top">
        ...
        <section className="market-hero" aria-labelledby="market-title">
          <div className="orbital-hud" aria-hidden="true"><span className="orbital-hud__ring orbital-hud__ring--outer" /><span className="orbital-hud__ring orbital-hud__ring--inner" /><span className="orbital-hud__axis" /><span className="orbital-hud__node" /><small>{market.symbol} · PRICE VECTOR</small></div>
      ...
      <footer className="foot-dense"><p className="foot-dense__statement">READ THE SIGNAL. WAIT FOR THE WINDOW.</p><p className="foot-dense__meta"><span>XAUWATCH v0.9 · {analysis.symbol} · {analysis.source.toUpperCase()} · DATA {freshness}</span><span>ไม่ใช่คำรับรองผลกำไร · ตรวจสอบราคา ข่าว และ contract size ก่อนส่งคำสั่งจริง</span></p></footer>
    </>
  );
}
